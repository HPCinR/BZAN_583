...
## Pseudo Random Number Generators (RNG) {background-image="/pics/fork/Fork6.png" background-size="90%" background-position="bottom" .smaller}
...
[**Guaranteed**]{style="color:green;"} independent streams
...
## `rf_mc.sh`
```{.bash code-line-numbers="|1|4|6-10|12|13|14"}
{{< include _code/rf_mc.sh >}} 
```

## Crossvalidation Example
<br>

### Random forest $m$, the number of predictors sampled
<br>
