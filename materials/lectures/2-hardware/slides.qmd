...
## Two (Three) Basic Concepts in Hardware {background-image="/pics/ParallelHardware/Slide7.png" background-size="1200px" background-position="center"}
...
## Two (Three) Basic Concepts in Hardware {background-image="/pics/ParallelHardware/Slide1.png" background-size="1000px" background-position="center"}
