---
title: "Memory Hierarchies and Hardware"
format: 
  revealjs:
    chalkboard: true
editor: source
...
## Titan{background-image="/pics/ParallelHardware/Titan.png" background-size="70%" background-position="bottom"}
### 27 PF
#### 2012-19
...
## Two (Three) Basic Concepts in Hardware {background-image="/pics/ParallelHardware/ParallelHardware1.png" background-size="90%" background-position="center"}
...
-   [*Multiple Instruction, Multiple Data (**MIMD**):*]{style="color:green;"} multiple cores in a single processor, multiple processors in a single computer, and multiple computers in a cluster (today's CPU and GPU but leaning to legacy)
-   [*Multiple Instruction, Single Data (**MISD**):*]{style="color:green;"} is not used much

## Three Processor Technology Streams
...
-   **Unix fork:** fork a process and let the OS manage it  
-   **Multithreading:** explicitly program parallel sections  
-   **OpenMP:** give explicit hints to a compiler to make it parallel  

### Distributed Memory Parallel  
-   **Manager-workers:** most common in simple cases  
-   **Single program, multiple data (SPMD):** most common and most scalable across nodes on clusters  
...
## Two (Three) Basic Concepts in Hardware {background-image="/pics/ParallelHardware/ParallelHardware2.png" background-size="90%" background-position="center"}

## Two (Three) Basic Concepts in Hardware {background-image="/pics/ParallelHardware/ParallelHardware3.png" background-size="90%" background-position="center"}

##  {background-image="/pics/ParallelHardware/ParallelHardware4.png" background-size="90%" background-position="center"}

##  {background-image="/pics/ParallelHardware/ParallelHardware5.png" background-size="90%" background-position="center"}

##  {background-image="/pics/ParallelHardware/ParallelHardware6.png" background-size="90%" background-position="center"}

##  {background-image="/pics/ParallelHardware/ParallelHardware7.png" background-size="90%" background-position="center"}

##  {background-image="/pics/ParallelHardware/ParallelHardware8.png" background-size="90%" background-position="center"}
