...
## Gather Collective Operations {background-image="/pics/ParallelSoftware/ParallelSoftware11.png" background-size="10%" background-position="bottom right" .smaller}

$$\small \bf A = \left[ \begin{array} \\ {X_1} \\ X_2 \\ \vdots \\ X_n \end{array} \right]$$  
...
## Distributed I/O is Fast

```
[gostrouc@dt-login02 ~]$ du -hs /projects/bckj
163G	/projects/bckj
```
