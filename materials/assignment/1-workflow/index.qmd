...
**Result 1:** Turn in the result of the following shell commands that you run on a Delta login node after logging in.
...
```
**Result 2:** Use the `man` Unix command to get a description of what each command does. Turn in a short one-sentence description for each command.

**Result 3:** On GitHub ... navigate to your Profile 

After preparing all the required results, please experiment further with Linux commands. 