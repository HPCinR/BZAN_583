...
Lectures: [Methods that Rely on Sampling](materials/lectures/5-sampling) [BLAS Libraries](materials/lectures/5-blas)
Assignment: [Resampling Estimators](5-resampling)

*Week 6, April 22 & 24*

Lectures: [LLM or Torch for R](materials/lectures/6-nn)\
Assignment: [A classification task](materials/assignment/6-nn) 
