...
Feel free to use either in this class but be aware of the difference and be consistent in using one or the other. This class will not consider programming style in evaluations.
