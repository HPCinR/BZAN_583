...
The weekly assignments are worth 12% each and the project with presentation is 25%. While each group is assigned a grade that all members receive, at the end of the course all members will evaluate and specify the kind of their own and others' relative contributions. The remaining 3% will be based on these evaluations and on class attendance, which will be taken at each lecture.
